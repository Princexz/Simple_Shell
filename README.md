...
Prince Solomon and  Thulile Makhubela Makhubela Shell is a simple UNIX command interpreter that replicates functionalities of the simple shell (sh). Additional functions are also included. This program was written entirely in C as a milestone project for ALX Africa Software Engineering.
...
You can use a browser to open this tutorial on github: https://github.com/Princexz/Simple_Shell
...
git clone https://github.com/princexz/Simple_Shell.git
...
Please take a look at the [Shell Cheat Sheet] (https://github.com/princexz/Simple_Shell/README.md) to refresh what you have learned and to get a quick overview of some other topics.
